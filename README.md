...
FastShell utilizes open source components running on the Terminal/command-line for it's work-flow, you'll need to install Node and Gulp. Here's a walk-through of how to get a project up and running in minutes. Once Node and Gulp are installed all future projects running Gulp are instant.
